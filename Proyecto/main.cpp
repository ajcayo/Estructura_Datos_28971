...
void menuOrdenar(ListaUsuarios& lu, ListaVehiculos& lv, ListaDoble& lr);
...
bool pedirFechaReserva(int& dia, int& mes, int& anio) {
    ...
    // Macro bisiesto (compatible C++11)
    ...
    else if (mes == 2) diasMax = esBisiesto(anio) ? 29 : 28;
...
void menuReservas(ListaDoble& lr, ListaUsuarios& lu, ListaVehiculos& lv) {
    ...
    // Funcion auxiliar compatible C++11: nombre del dia de la semana
    struct DiaHelper {
        static string nombre(int w) {
    ...
    do {
        ...
        if (op == 1) {
            ...
            cout << "\n  [INFO] Turno asignado para: "
                 << DiaHelper::nombre(fecha.tm_wday) << " "
...
// ============================================================
//  MENU ORDENAR POR INTERCAMBIO
// ============================================================
void menuOrdenar(ListaUsuarios& lu, ListaVehiculos& lv, ListaDoble& lr) {
    int op;
    do {
        cout << "\n========== ORDENAR POR INTERCAMBIO ==========\n";
        cout << "1. Ordenar Usuarios\n";
        cout << "2. Ordenar Vehiculos\n";
        cout << "3. Ordenar Reservas\n";
        cout << "4. Volver al Menu Principal\n";
        op = Validador::leerEntero("Opcion: ", 1, 4);

        if (op == 1) {
            int crit;
            cout << "\n  --- Criterio de ordenamiento (Usuarios) ---\n";
            cout << "  1. Por Nombre\n";
            cout << "  2. Por Apellido\n";
            crit = Validador::leerEntero("  Criterio: ", 1, 2);
            // criterio 1=nombre, 0=apellido
            lu.ordenamientoIntercambio(crit == 1 ? 1 : 0);

        } else if (op == 2) {
            cout << "\n  Ordenando vehiculos por placa...\n";
            lv.ordenamientoIntercambio(0);

        } else if (op == 3) {
            int crit;
            cout << "\n  --- Criterio de ordenamiento (Reservas) ---\n";
            cout << "  1. Por Fecha\n";
            cout << "  2. Por Hora\n";
            crit = Validador::leerEntero("  Criterio: ", 1, 2);
            // criterio 0=fecha, 1=hora
            lr.ordenamientoIntercambio(crit == 1 ? 1 : 0);
        }
...
int main() {
    ...
    do {
        ...
        cout << "5. Ordenar por Intercambio\n";
        cout << "6. Salir\n";
        op = Validador::leerEntero("Opcion: ", 1, 6);
        ...
        switch (op) {
            ...
            case 5:
                menuOrdenar(masterUsuarios, masterVehiculos, masterReservas);
                break;
            case 6:
                cout << "\n  Hasta pronto.\n";
                break;
